            ...
            <section id="recent-blog-posts" class="recent-blog-posts">
              <div class="row">
                ...
                <?php
                  ...
                  if($MClase == 0){
                    $Objetos = ControladorGeneral::ctrMostrar("publicar", "fecha", null, null, $base, $tope, "DESC");
                    $listaObjetos = ControladorGeneral::ctrListar("publicar", null, null);
                  }else if($MClase == 1||$MClase == 2||$MClase == 3){
                    $Objetos = ControladorGeneral::ctrMostrar("publicar", "fecha", "categoria", $MClase, $base, $tope, "DESC");
                    $listaObjetos = ControladorGeneral::ctrListar("publicar", "categoria", $MClase);
                  }
