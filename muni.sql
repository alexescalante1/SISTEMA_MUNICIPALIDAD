...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-07-2021 a las 02:50:47
...
(5, '73104785', '', 'Alex Escalante ONE', 'admin@gmail.com', 'vistas/img/perfiles/138.jpg', '$2a$07$asxx54ahjppf45sd87a5aunxs9bkpyGmGE/.vekdjFg83yRec789S', 'administrador', 1, 1, '2021-07-17 17:06:19'),
...
(727, 0, 0, 0, 0, 0, 5, 159),
(728, 0, 0, 0, 0, 1800, 6, 159),
(729, 0, 0, 0, 0, 1200, 11, 159),
(730, 0, 123, 0, 0, 1900, 10, 159),
(731, 0, 0, 0, 0, 0, 5, 160),
(732, 0, 0, 0, 0, 0, 6, 160),
...
(266, 'lolicon', 'lolicon', 'helloda', 1, 'vistas/img/productos/lolicon.jpg', '[{\"foto\":\"vistas/img/multimedia/lolicon/952042.jpg\"},{\"foto\":\"vistas/img/multimedia/lolicon/546966.jpg\"},{\"foto\":\"vistas/img/multimedia/lolicon/1002151.png\"},{\"foto\":\"vistas/img/multimedia/lolicon/957926.png\"}]', 0, 0, 0, 42, 'asdasd', '2021-07-17 19:38:38');
...
(159, 'examen-noviembre-2021', 'EXAMEN NOVIEMBRE 2021', '2021-07-16 00:52:40', '2021-03-26', '2022-12-25', 1),
...
(111, 1, 'alex', 'fredy', 'aaa', 'aaa', 'aaa', 'aaa', 115),
(112, 2, 'escalante', 'maron', 'jjkhuu', 'uuu', 'hjhh', 'h', 115);
...
--
ALTER TABLE `cupos`
  MODIFY `idCupos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=735;

--
-- AUTO_INCREMENT de la tabla `detallearticulo`
--
ALTER TABLE `detallearticulo`
  MODIFY `idDetalleArticulo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=267;
...
--
ALTER TABLE `eventoadmision`
  MODIFY `idAdmision` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT de la tabla `examen`
--
ALTER TABLE `examen`
  MODIFY `idExamen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
...
--
ALTER TABLE `problemas`
  MODIFY `idProblemas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- AUTO_INCREMENT de la tabla `solucion`
--
ALTER TABLE `solucion`
  MODIFY `idSolucion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=339;
