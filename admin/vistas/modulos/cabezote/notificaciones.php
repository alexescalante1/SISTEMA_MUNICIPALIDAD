...
<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
	<span class="dropdown-item dropdown-header">Tienes 8 Notificaciones Nuevas</span>
	
	<div class="dropdown-divider"></div>
	<a href="notificacionesM" class="dropdown-item">
	<i class="fas fa-envelope mr-2"></i> 4 Prestamos Pendientes
	<span class="float-right text-muted text-sm">3 mins</span>
	</a>

	<div class="dropdown-divider"></div>
	<a href="usuarios" class="dropdown-item">
	<i class="fas fa-users mr-2"></i> 4 Usuarios Morosos
